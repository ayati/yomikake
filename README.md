...
- **読みかけリスト**：ウェルカム画面に「読みかけ」の本を一覧表示。表紙サムネイル・著者名・進捗バー・最終閲覧日付きのカードから次に読む本を選択できる。Chrome/Edge では File System Access API、iOS Safari では IndexedDB の ePub キャッシュ（v1.8.8、直近 3 冊 LRU）により、いずれもファイルピッカーなしで直接再開可能
